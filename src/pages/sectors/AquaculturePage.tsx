    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12 hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">O que é Água sense </h2>
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-6">O que é Piscicultura?</h2>
          <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-4">Relação com a Aquaponia</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12 hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Benefícios da Aplicação de Tecnologia em Sistemas de Aquaponia</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
              <h4 className="font-semibold text-gray-800 mb-2">Redução de perdas e falhas operacionais</h4>
              <p className="text-gray-700">O monitoramento inteligente ajuda a identificar e corrigir problemas rapidamente, minimizando perdas.</p>
            </div>
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
              <h4 className="font-semibold text-gray-800 mb-2">Aumento de produtividade</h4>
              <p className="text-gray-700">A otimização do ambiente e das condições de cultivo leva a um melhor desempenho tanto dos peixes quanto das plantas.</p>
            </div>
            <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
              <h4 className="font-semibold text-gray-800 mb-2">Maior segurança na produção</h4>
              <p className="text-gray-700">O controle preciso dos parâmetros garante um ambiente mais estável e seguro para os organismos aquáticos e vegetais.</p>
            </div>
            <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
              <h4 className="font-semibold text-gray-800 mb-2">Decisões baseadas em dados</h4>
              <p className="text-gray-700">A coleta e análise de dados em tempo real permitem que os produtores tomem decisões mais informadas e eficientes.</p>
            </div>
            <div className="bg-teal-50 p-6 rounded-lg border-l-4 border-teal-500 md:col-span-2">
              <h4 className="font-semibold text-gray-800 mb-2">Sustentabilidade e eficiência no manejo</h4>
              <p className="text-gray-700">A tecnologia contribui para um uso mais consciente dos recursos, promovendo práticas mais sustentáveis e eficientes na gestão do sistema.</p>
            </div>
          </div>
        </div>
        {/* Contact Section */}
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-8">
              ...
              <div className="flex justify-center space-x-6">
                <div className="bg-white bg-opacity-20 p-3 rounded-full hover:bg-opacity-30 transition-all duration-300 cursor-pointer">
