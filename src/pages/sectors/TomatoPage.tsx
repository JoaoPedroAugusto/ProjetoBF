  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12 border-l-4 border-red-500">
          <div className="flex items-center mb-6">
            <Target className="h-8 w-8 text-red-600 mr-3" />
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Resumo da Ideia</h2>
          </div>
        ...
        <div className="mb-12">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Inovações Diferenciais</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Embalagem EPEA */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border-l-4 border-green-500 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-4">
                <Package className="h-10 w-10 text-green-600 mr-4" />
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200">Embalagem Inteligente EPEA</h3>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border-l-4 border-blue-500 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-4">
                <Truck className="h-10 w-10 text-blue-600 mr-4" />
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200">Transporte com Refrigeração Sustentável</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-red-500 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center mb-4">
        ...
        <div className="mb-12">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Como Funciona Nossa Plataforma</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200">Introdução à Iniciativa</h3>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200">Tomada de Decisão</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200">Impacto em Números</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            <div className="bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200">Credibilidade</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
