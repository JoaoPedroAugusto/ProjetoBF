        ...
        <div className="relative container mx-auto px-4 py-16 h-full flex items-center">
          <div className="text-white">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <div className="bg-white dark:bg-gray-800/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-2">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-6">🔄 Fluxo de Dados em Tempo Real</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Sensores IoT no campo capturam dados de solo, clima, crescimento e aplicação de insumos a cada 15 minutos</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">IA analisa os dados, detecta padrões e gera insights para otimização da produção</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Todas as informações são criptografadas e registradas de forma imutável na blockchain</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Sistema valida automaticamente conformidade com padrões Bonsucro e ISCC</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-green-500">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">100% Rastreável</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Blockchain Seguro</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">IoT + IA</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Valorização das práticas sustentáveis e qualidade superior</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Dados para melhorar produtividade e reduzir custos</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Abertura de novos mercados premium e certificados</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Atendimento a regulamentações e padrões internacionais</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Otimização de processos e redução de desperdícios</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Diferenciação competitiva e valor agregado</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Garantia de origem e autenticidade do produto</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Decisões informadas sobre sustentabilidade</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Acesso a produtos de qualidade comprovada</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* ODS */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-8 text-center">Objetivos de Desenvolvimento Sustentável (ODS)</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-red-50 rounded-lg p-4 text-center">
              <Target className="h-8 w-8 text-red-600 mx-auto mb-2" />
              <h4 className="font-semibold text-gray-800 dark:text-gray-200">ODS 2</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Fome Zero e Agricultura Sustentável</p>
            </div>
            <div className="bg-yellow-50 rounded-lg p-4 text-center">
              <Target className="h-8 w-8 text-yellow-600 mx-auto mb-2" />
              <h4 className="font-semibold text-gray-800 dark:text-gray-200">ODS 7</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Energia Limpa e Acessível</p>
            </div>
            <div className="bg-pink-50 rounded-lg p-4 text-center">
              <Target className="h-8 w-8 text-pink-600 mx-auto mb-2" />
              <h4 className="font-semibold text-gray-800 dark:text-gray-200">ODS 8</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Trabalho Decente e Crescimento Econômico</p>
            </div>
            <div className="bg-orange-50 rounded-lg p-4 text-center">
              <Target className="h-8 w-8 text-orange-600 mx-auto mb-2" />
              <h4 className="font-semibold text-gray-800 dark:text-gray-200">ODS 9</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Indústria, Inovação e Infraestrutura</p>
            </div>
            <div className="bg-yellow-50 rounded-lg p-4 text-center">
              <Target className="h-8 w-8 text-yellow-600 mx-auto mb-2" />
              <h4 className="font-semibold text-gray-800 dark:text-gray-200">ODS 12</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Consumo e Produção Responsáveis</p>
            </div>
            <div className="bg-green-50 rounded-lg p-4 text-center">
              <Target className="h-8 w-8 text-green-600 mx-auto mb-2" />
              <h4 className="font-semibold text-gray-800 dark:text-gray-200">ODS 13</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Ação Contra a Mudança do Clima</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Análise de Custos e Lucratividade</h2>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">Investimento Inicial</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">Retorno sobre Investimento</h3>
              <div className="space-y-4">
                <div className="bg-green-50 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    <TrendingUp className="h-5 w-5 text-green-600 mr-2" />
                    <span className="font-semibold text-gray-800 dark:text-gray-200">Aumento do Valor do Produto</span>
                  </div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">15% a 30% de premium por produtos certificados</p>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    <Zap className="h-5 w-5 text-blue-600 mr-2" />
                    <span className="font-semibold text-gray-800 dark:text-gray-200">Redução de Custos</span>
                  </div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">15-20% economia em insumos e operações</p>
                </div>
                <div className="bg-purple-50 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    <Award className="h-5 w-5 text-purple-600 mr-2" />
                    <span className="font-semibold text-gray-800 dark:text-gray-200">ROI Estimado</span>
                  </div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">20% a 50% de aumento na margem de lucro</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center space-x-4">
          <Link
            to="/sectors/SugarcaneCulturePage"
