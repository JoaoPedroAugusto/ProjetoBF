...
import { Beef, TrendingUp, MapPin, Leaf, AlertTriangle, DollarSign, Presentation } from 'lucide-react'; // Import Presentation icon
...
export const MeatPage: React.FC = () => {
  const [showPresentation, setShowPresentation] = useState(false); // Add state for presentation

  // Conditionally render PresentationManager if showPresentation is true
  if (showPresentation) {
    return (
      <PresentationManager
        sectorId="meat" // Use the appropriate sectorId for Meat
        sectorName="Carne"
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-6">Técnicas de Produção</h2>
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p className="text-gray-700 dark:text-gray-300">Sistemas de pastoreio rotacional para bovinos</p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p className="text-gray-700 dark:text-gray-300">Habitação com controle climático para aves</p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p className="text-gray-700 dark:text-gray-300">Tecnologias de alimentação de precisão</p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p className="text-gray-700 dark:text-gray-300">Seleção genética para produtividade melhorada</p>
              </div>
            </div>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-6">Problemas Comuns</h2>
            <div className="space-y-4">
              <div className="border-l-4 border-red-400 pl-4">
                <div className="flex items-center mb-2">
                  <AlertTriangle className="h-5 w-5 text-red-500 mr-2" />
                  <h3 className="font-semibold text-gray-800 dark:text-gray-200">Febre aftosa</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Doença viral altamente contagiosa que afeta animais de casco fendido.</p>
              </div>
              <div className="border-l-4 border-red-400 pl-4">
                <div className="flex items-center mb-2">
                  <AlertTriangle className="h-5 w-5 text-red-500 mr-2" />
                  <h3 className="font-semibold text-gray-800 dark:text-gray-200">Gripe aviária</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Infecção viral que pode causar alta mortalidade em bandos de aves.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-12">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Informações de Mercado</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Preço Atual</p>
              <p className="text-xl font-bold text-red-600">Bovina: $4.50/kg</p>
              <p className="text-xl font-bold text-red-600">Aves: $2.20/kg</p>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Tendência</p>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">Demanda crescente em países em desenvolvimento equilibrada por alternativas vegetais</p>
            </div>
          </div>
        </div>
