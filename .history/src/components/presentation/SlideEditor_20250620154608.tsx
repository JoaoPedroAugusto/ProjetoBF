  ...
  const addToMediaLibrary = async (file: File): Promise<string> => {
    try {
      ...
      if (file.type.startsWith('image/')) {
        ...
        // Para vídeos pequenos, usar base64. Para grandes, mostrar erro
        if (file.size > 10 * 1024 * 1024) {
          throw new Error('Arquivo de vídeo muito grande. Máximo 10MB para garantir funcionamento correto.');
        }
        
        // Usar base64 para vídeos pequenos para garantir persistência
